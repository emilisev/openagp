...
<div class="row align-items-center">
    <div id="time-in-range" class="card col-6">
        <header class="card-title">Durée dans les plages</header>
...
<div id="agp" class="card">
    <header class="card-title">Ambulatory Glucose Profile (AGP)</header>
    <content class="card-body">
...
<div id="daily" class="card">
    <header class="card-title">Profil glycémique quotidien sur les 15 derniers jours</header>
    <content class="card-body">
